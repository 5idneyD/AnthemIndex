<template>
	<v-row class="gap-6" align="stretch">
		...
		<v-col cols="12" md="6" class="d-flex flex-column gap-6">
			<div class="neo-card px-8 mt-14 py-6 h-50 flex flex-col overflow-auto">
				<div>
					...
					<br />
					<p>
						Select any country from our dropdown menu at the top or try the random country suggested below!
					</p>
					<br/>
					<p>
						Each anthem has a unique story to tell, reflecting the history, culture, and values of its nation.
					</p>
					<br/>
					<p>
						Each page contains the lyrics, both n the home language and in English, as well as an audio player to listen to the anthem.
					</p>
				</div>
			</div>
			<RandomCountry />
